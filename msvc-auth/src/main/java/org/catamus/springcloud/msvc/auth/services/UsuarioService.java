package org.catamus.springcloud.msvc.auth.services;

import org.catamus.springcloud.msvc.auth.models.Usuario;
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        try {
            Usuario usuario = client
                    .build()
                    .get().uri("http://msvc-usuarios/login", uri -> uri.queryParam("email", email).build())
